...
// QSPI flash sim model on SPI1 -- only drives during the data phase of a
// Fast Read (opcode 0xEB); 1-bit transactions see a tristated bus that
// floats high here, matching the iter-1 wp_n/hold_n tie-off behaviour.
...
B32P3 cpu (
    ...
    .interrupts({dma_irq, 2'd0, OST3_int, OST2_int, OST1_int, uart_irq})
);
