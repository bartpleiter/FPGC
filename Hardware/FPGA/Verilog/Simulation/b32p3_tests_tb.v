 ...
 * 
 * This is a copy of cpu_tests_tb.v but using B32P3 instead of B32P2
 */
`timescale 1ns / 1ps
...
wire HDMI_D0_P, HDMI_D0_N;
wire HDMI_D1_P, HDMI_D1_N;
wire HDMI_D2_P, HDMI_D2_N;
...
initial begin
    $dumpfile("Hardware/FPGA/Verilog/Simulation/Output/b32p3_test.vcd");
    $dumpvars(0, b32p3_tb);
end
