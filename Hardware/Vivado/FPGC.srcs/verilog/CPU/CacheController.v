...
(
    ...
    output reg cpu_EXMEM2_ready = 1'b0,
...
// TODO: implement state machine, these are remains of L1i cache controller
...
// reg [31:0] stored_cpu_addr = 32'b0;
// reg [255:0] cache_line_data = 256'b0;
// reg [15:0] cache_tag = 16'b0;
// reg [2:0] word_offset = 3'b0;
