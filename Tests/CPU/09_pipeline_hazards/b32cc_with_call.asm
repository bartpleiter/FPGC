...
Main:
    ...
    sub r13 24 r13         ; allocate stack frame
    write 16 r13 r14       ; save old r14
    add r13 16 r14         ; r14 = new base pointer
    
    ; Store values like fixedmath test
    load32 327680 r1      ; r1 = 5 << 16 = 0x50000
    write -4 r14 r1       ; store a at -1
    load32 196608 r1      ; r1 = 3 << 16 = 0x30000  
    write -8 r14 r1       ; store b at -2
    
    ; Read values back
    read -4 r14 r1        ; read a
    read -8 r14 r8        ; read b
    
    ; Subtract
    sub r1 r8 r1          ; c = a - b = 0x20000
    
    ; Store and immediately read (store-to-load hazard)
    write -12 r14 r1       ; store c at -3
    read -12 r14 r4        ; read c into r4 (argument register)
    
    ; Call function (exactly like B32CC does)
    sub r13 16 r13         ; adjust stack for call
    savpc r15             ; save return address
    add r15 12 r15         ; adjust for call
    jump shift_right_16   ; call function
    sub r13 -16 r13        ; restore stack after return
...
shift_right_16:
    ...
    read 8 r14 r1         ; read argument (offset 2 from new r14)
    shiftrs r1 16 r1      ; shift right signed by 16
    read 0 r14 r14        ; restore old r14
    add r13 8 r13         ; restore stack
