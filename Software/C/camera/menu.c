...
#define MENU_LAST_ITEM  16   /* last selectable item row */
#define MENU_HINT_ROW1  18
#define MENU_HINT_ROW2  19
#define MENU_BOT_ROW    20   /* bottom border */
...
/* Item labels (must match MENU_ITEMS = 13) */
static const char *item_labels[13] = {
    "Shutter",
    "Exposure",
    "ISO",
    "Brightness",
...
static const int item_manual_only[13] = {
...
static const char *item_value_str(int i)
{
    ...
    case 7:  return cam_settings.auto_contrast ? "On" : "Off";
    case 8:
        switch (display_mode) {
...
void menu_draw(void)
{
    ...
    menu_puts(MENU_LABEL_COL, MENU_HINT_ROW1, "[/] Navigate  [-/=] Adjust", MENU_PAL_IDX);
    {
        int x;
    ...
    menu_puts(MENU_LABEL_COL, MENU_HINT_ROW2, "[TAB] Close menu", MENU_PAL_IDX);
    {
        int x;
