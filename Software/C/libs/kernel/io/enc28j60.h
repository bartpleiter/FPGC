...
/*  Bit 7:     1 = MAC/MII reg (needs dummy byte on SPI read)   */
/* ============================================================ */
 ...
 * @return Hardware revision (>0 on success), 0 on failure
 */
 ...
 * @return Number of packets waiting in the RX buffer
 */
 ...
 * @param len  Length of frame in bytes (including Ethernet header, excluding CRC)
 * @return 1 on success, 0 on failure (timeout or transmit error)
 */
 ...
 * @param max_len  Maximum number of bytes to copy into buf
 * @return Number of bytes copied (0 if no packet available)
 */
