...
// Assert chip select for SPI bus 0.
void spi_0_select()
{
  asm(
...
// Deassert chip select for SPI bus 0.
void spi_0_deselect()
{
  asm(
      "load32 0x7000009 r11 ; r11 = SPI0 cs register"
...
// Transfer one byte on SPI bus 0 and return received data.
...
// Assert chip select for SPI bus 1.
void spi_1_select()
{
  asm(
...
// Deassert chip select for SPI bus 1.
void spi_1_deselect()
{
  asm(
      "load32 0x700000B r11 ; r11 = SPI1 cs register"
...
// Transfer one byte on SPI bus 1 and return received data.
...
// Assert chip select for SPI bus 2.
void spi_2_select()
{
  asm(
...
// Deassert chip select for SPI bus 2.
void spi_2_deselect()
{
  asm(
      "load32 0x700000D r11 ; r11 = SPI2 cs register"
...
// Transfer one byte on SPI bus 2 and return received data.
...
// Assert chip select for SPI bus 3.
void spi_3_select()
{
  asm(
...
// Deassert chip select for SPI bus 3.
void spi_3_deselect()
{
  asm(
      "load32 0x7000010 r11 ; r11 = SPI3 cs register"
...
// Transfer one byte on SPI bus 3 and return received data.
...
// Assert chip select for SPI bus 4.
void spi_4_select()
{
  asm(
...
// Deassert chip select for SPI bus 4.
void spi_4_deselect()
{
  asm(
      "load32 0x7000013 r11 ; r11 = SPI4 cs register"
...
// Transfer one byte on SPI bus 4 and return received data.
...
// Assert chip select for SPI bus 5.
void spi_5_select()
{
  asm(
...
// Deassert chip select for SPI bus 5.
void spi_5_deselect()
{
  asm(
      "load32 0x7000016 r11 ; r11 = SPI5 cs register"
...
// Transfer one byte on SPI bus 5 and return received data.
...
// Transfer one byte on the selected SPI bus.
...
// Assert chip select for the selected SPI bus.
...
// Deassert chip select for the selected SPI bus.
