...
This documentation page is a markdown summary/copy of parts of the Xilinx MIG 7 Series user guide documentation that can be found [here](https://www.xilinx.com/support/documents/ip_documentation/mig_7series/v4_1/ug586_7Series_MIS.pdf). I find this useful to have for checking how to interface with the MIG 7, but also as context for LLM prompts to spot issues with my mock/implementation/connection.
...
- Make sure `app_wdf_rdy` is one before sending a write command (although I do not think I will ever fill the FIFO until implementation of a write buffer).
